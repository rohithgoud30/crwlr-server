...
create_trigger "main" "crwlr-server"
create_trigger "test" "crwlr-server-test"
create_trigger "dev" "crwlr-server-dev"

echo "Setup complete!"
echo "Three Cloud Build triggers have been created:"
echo "1. github-trigger-main - Deploys to crwlr-server from the main branch"
echo "2. github-trigger-test - Deploys to crwlr-server-test from the test branch"
echo "3. github-trigger-dev - Deploys to crwlr-server-dev from the dev branch"
echo ""
